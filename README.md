...
**T-TA**, or **T**ransformer-based **T**ext **A**utoencoder, is a new model for learning bidirectional language representations which
has potentials on a wide array of Natural Language Processing (NLP) tasks.

Our academic paper which describes BERT in detail and provides full results on a
number of tasks can be found here:
[https://arxiv.org](https://arxiv.org/abs/1810.04805).
